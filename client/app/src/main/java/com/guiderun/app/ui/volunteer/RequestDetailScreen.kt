...
private fun RequestDetailContent(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.request_detail_runner, request.blindRunner?.nickname ?: ""),
            style = MaterialTheme.typography.headlineSmall,
        )
        Text(
            text = stringResource(R.string.request_detail_location, request.meetingLocation.description),
            style = MaterialTheme.typography.bodyLarge,
        )
        Text(
            text = stringResource(R.string.request_detail_duration, request.expectedDurationMinutes),
            style = MaterialTheme.typography.bodyMedium,
        )
        request.notes?.let { notes ->
            Text(
                text = stringResource(R.string.request_detail_notes, notes),
                style = MaterialTheme.typography.bodyMedium,
